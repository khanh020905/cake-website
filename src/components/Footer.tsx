      ...
      <div className="max-w-[1250px] mx-auto w-full flex-1">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-between items-center lg:items-end mb-24 lg:mb-32 gap-12">
          ...
          <div className="max-w-xl text-center lg:text-left">
            <h3 className="font-serif text-[38px] md:text-[50px] leading-tight mb-4">
              Stay <span className="italic text-[#cca9cd] font-light">Sweet.</span>
            </h3>
            <p className="font-sans font-light text-white/70 text-[15px] md:text-[16px] tracking-wide leading-relaxed">
              Join our list to receive priority updates on seasonal items, secret menu drops, and local catering events.
            </p>
          </div>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8 mb-20 items-start text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            <h4 className="font-sans font-semibold text-[12px] tracking-[0.25em] uppercase text-[#cca9cd] mb-3">Visit Us</h4>
          ...
          {/* Column 2 */}
          <div className="flex flex-col items-center md:items-start space-y-4">
            <h4 className="font-sans font-semibold text-[12px] tracking-[0.25em] uppercase text-[#cca9cd] mb-3">Contact</h4>
          ...
          {/* Column 3 */}
          <div className="flex flex-col items-center md:items-start space-y-4">
            <h4 className="font-sans font-semibold text-[12px] tracking-[0.25em] uppercase text-[#cca9cd] mb-3">Follow</h4>
